...
#include "ui_rybakova_popkova.h"
#include <QFileDialog>
#include <QTextStream>
#include <QMessageBox>

Rybakova_Popkova::Rybakova_Popkova(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::Rybakova_Popkova)
{
    ui->setupUi(this);
}

void Rybakova_Popkova::recieveData(QString str)
{
...
void Rybakova_Popkova::on_buttonBox_clicked(QAbstractButton *button)
{
...
Rybakova_Popkova::~Rybakova_Popkova()
{
    delete ui;
}
